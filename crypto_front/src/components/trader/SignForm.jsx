...
// import { signInAction, signUpAction } from "./traderSlice"
...
//         traderMode === "Sign in" ? dispatch(signInAction(credentials)) : dispatch(signUpAction(credentials))
//         navigate('/')
//     }
...
//                     rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{traderMode}</button>
//                 <button 
//                     className="btn btn-primary ms-auto"
//                     onClick={() => dispatch(setTraderMode(traderMode === "Sign in" ? "Register" : "Sign in"))}>
//                         {traderMode === "Sign in" ? "Register" : "Sign in"}
//                 </button>
//             </div>
//         </form>
//     </>
